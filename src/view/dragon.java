...
public class dragon extends Fruits {
  ...
  public dragon() {
	...
	public  dragon(Image image, double x, double y, Group group) {
     
		imgdragon = new ImageView(image);
		imgdragon.setX(x);
		imgdragon.setY(y);
		imgdragon.setFitWidth(150);
		imgdragon.setFitHeight(100);
       ...
       group.getChildren().add(imgdragon);		
	}
	...
	public void appearFruit(Group group) {
      ...
      makeAnimation.getKeyFrames().add(new KeyFrame( Duration.millis(getActions().levelvelocityX()),e->{
                    ...
                    System.out.println("special has moved off");
              ...
              new KeyValue(getImgdragon().xProperty(), 700),new KeyValue(getImgdragon().yProperty(),900),new KeyValue(getImgdragon().rotateProperty(), 700)));
   
      makeAnimation.getKeyFrames().add(new KeyFrame( Duration.millis(getActions().levelvelocityY()),
              new KeyValue(getImgdragon().xProperty(),400 ),new KeyValue(getImgdragon().yProperty(),300),new KeyValue(getImgdragon().rotateProperty(), 500)));
    ...
    /**
     * @param imgdragon the imgdragon to set
     */
