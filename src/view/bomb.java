...
public class bomb {
	...
	public  bomb(Image image, double x, double y, Group group) {
	...
	public void appearBomb(Group group) {
		Timeline makeAnimation = new Timeline();
		  AudioClip cut = new AudioClip(this.getClass().getResource("/sounds/bomb_appear.mp3").toExternalForm());
     
        cut.setCycleCount(1);
        cut.play();
        makeAnimation.getKeyFrames().add(new KeyFrame( Duration.millis(2460),
                new KeyValue(this.getImgBomb().xProperty(), 800),new KeyValue(this.getImgBomb().yProperty(),700),new KeyValue(this.getImgBomb().rotateProperty(), 400)));
    
        makeAnimation.getKeyFrames().add(new KeyFrame( Duration.millis(1230),
                new KeyValue(this.getImgBomb().xProperty(),350 ),new KeyValue(this.getImgBomb().yProperty(),100),new KeyValue(this.getImgBomb().rotateProperty(), 200)));
